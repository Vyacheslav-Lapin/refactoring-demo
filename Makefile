...
build:
	./mvnw verify
	chmod +x ./target/refactoring-demo-0.0.1-SNAPSHOT.jar

run:
	./mvnw spring-boot:run -Dspring.profiles.active=local
	#	./target/refactoring-demo-0.0.1-SNAPSHOT.jar
	#	java -jar --enable-preview ./target/refactoring-demo-0.0.1-SNAPSHOT.jar
...
git-fork-init: init
	git remote add upstream git://github.com/Vyacheslav-Lapin/refactoring-demo.git
	git fetch upstream
